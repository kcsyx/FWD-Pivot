...
export default class QuizLevel2 extends Phaser.Scene {
    constructor() {
        super('QuizLevel2');
    }
    ...
    create() {
        ...
        this.question = this.add.text(100, config.height / 2 - 180, 'Pet  insurance  can  only  cover  cats  and  dogs', { fontSize: 36, fontFamily: "arcade_classic", wordWrap: { width: 660, useAdvancedWrap: false } });
        ...
        this.confirm.on('pointerdown', function () {
            ...
            if (self.choice == "choice2") {
                ...
                self.goNext.on('pointerdown', function () {
                    self.scene.start('QuizLevel3', { gender: self.gender, moneyBags: self.moneyBags, clockTime: self.clock.now });
                });
