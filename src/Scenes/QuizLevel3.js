...
export default class QuizLevel3 extends Phaser.Scene {
    constructor() {
        super('QuizLevel3');
    }
    ...
    create() {
        ...
        this.question = this.add.text(100, config.height / 2 - 180, 'Travel  insurance  can  only  cover  lost  luggage', { fontSize: 36, fontFamily: "arcade_classic", wordWrap: { width: 670, useAdvancedWrap: false } });
        ...
        this.confirm.on('pointerdown', function () {
            ...
            if (self.choice == "choice2") {
                ...
                self.goNext.on('pointerdown', function () {
                    self.scene.start('EndScreen', { gender: self.gender, moneyBags: self.moneyBags, clockTime: self.clock.now });
                });
